"""Command-line interface for reproducible Phase-3 forwarding experiments."""
...
def parser() -> argparse.ArgumentParser:
    ...
    result = argparse.ArgumentParser(description="NetSynth Phase-3 distributed-forwarding simulator")
